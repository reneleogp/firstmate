...
- [docs/telegram.md](docs/telegram.md) - current setup, mirror commands, voice flow, service lifecycle, and limits for the WSL and macOS Telegram terminal mirror.
