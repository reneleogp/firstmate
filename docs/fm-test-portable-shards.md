...
| portable serial 1-4 | job `timeout-minutes: 25` | Current shards can approach 15 minutes as duration hints age, so the bound leaves setup and runner-variance headroom while remaining a hang tripwire. |
