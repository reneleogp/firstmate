...
Queued and interrupted requests, handled identities, voice confirmations, and paired delivery metadata and body records are bounded and retained only for the documented transport windows.
