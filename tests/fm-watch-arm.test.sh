...
test_rearm_resurfaces_durable_queue_and_remote_open_decision() {
  ...
  # Recovery is asynchronous and can take more than a fixed quarter-second on
  # a loaded runner. Wait for the observable arm exit under the existing bound
  # instead of sampling its process state at one timing-sensitive instant.
